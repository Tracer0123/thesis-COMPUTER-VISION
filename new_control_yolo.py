...
from TTC_yolo import yolo_ttc, yolo_box, decision_sys
        ...
        for _frame in dir:  # using the saved frames ( pictures)
            ...
            if count > 1:
                ...
                if prev_gray is None:
                    ...
                    ttc, boxes, gray1, sections, _cl_id = yolo_ttc(frame, prev_cl_id, prev_boxes, prev_gray, frame_rate)
                    print(ttc)
                    prev_cl_id, prev_sections, prev_boxes, prev_gray = _cl_id, gray, boxes, gray1
